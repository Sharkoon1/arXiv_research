...
class AppColors {
  ...
  static const Map<String, Color> categoryColors = {
    ...
    'LLM': Color(0xFF6366F1),
    'multimodal': Color(0xFF06B6D4),
    'robotics': Color(0xFFF59E0B),
    'reasoning': Color(0xFF8B5CF6),
    'agents': Color(0xFF10B981),
    'efficiency': Color(0xFF3B82F6),
    'safety': Color(0xFFEF4444),
    'benchmark': Color(0xFFEC4899),
    'architecture': Color(0xFF14B8A6),
    'other': Color(0xFF6B7280),
  };

  // News category pill colors
  static const Map<String, Color> newsCategoryColors = {
    'research': Color(0xFF6366F1),
    'industry': Color(0xFF06B6D4),
    'policy': Color(0xFFF59E0B),
    'product': Color(0xFF10B981),
    'hardware': Color(0xFF3B82F6),
    'funding': Color(0xFF22C55E),
    'safety': Color(0xFFEF4444),
    'partnership': Color(0xFF8B5CF6),
    'other': Color(0xFF6B7280),
  };
}
