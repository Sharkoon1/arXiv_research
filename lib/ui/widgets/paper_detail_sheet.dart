                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Clipboard.setData(ClipboardData(text: paper.shortId));
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text('Copied: ${paper.shortId}'),
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              const Spacer(),
                              Icon(Icons.copy, size: 13, color: AppColors.textMuted),
                            ],
                          ),
                        ),
                      ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: isPrimary
              ? null
              : Border.all(color: AppColors.textMuted.withOpacity(0.25), width: 1),
        ),
        child: Row(
